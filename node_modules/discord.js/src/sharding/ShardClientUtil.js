...
class ShardClientUtil {
  ...
  constructor(client) {
    ...
    client.on('ready', () => { console.log("ShardClientUtil - Ready"); });
    client.on('disconnect', () => { console.log("ShardClientUtil - Connection Lost"); });
    client.on('reconnecting', () => { console.log("ShardClientUtil - Reconnecting..."); });
  }
